...
type Server struct {
	pb.UnimplementedMS_18750Server
}

const serviceName = "MS_18750"
...
func (s *Server) Run() error {
	...
	pb.RegisterMS_18750Server(srv, s)

	reflection.Register(srv)
	port := 2000
	if sidecar {
		port = utils.StrToInt(utils.GetEnvVar("MS_18750_PORT", true))
	}
...
func (s *Server) Vs2NQhH1Hq(ctx context.Context, req *pb.Request) (*pb.Response, error) {
	utils.BusyLoop(480)
