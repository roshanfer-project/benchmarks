...
mkdir -p "$OUTPUT_DIR"
declare -a log_pids=()
for svc in ms-25806 ms-2687 ms-40087 ms-44246 ms-51787 ms-56113 ms-64512 ms-70124 ms-64512-grpc rajomon-client; do
...
if [ "$MODE" = "envoy" ]; then
  ...
  for svc in ms-25806 ms-2687 ms-40087 ms-44246 ms-51787 ms-56113 ms-64512 ms-70124 ms-64512-grpc rajomon-client ingress; do
