...
import (
	...
	"fmt"
	"net"
<<<<<<< HEAD:tests/prob-route-fanout/services/backend6/main.go
	"probroutefanout/pkg"
...
=======
	...
	"dynamiclarge/utils"
>>>>>>> 7e20238 (rename test benchmark):tests/dynamic-large/services/backend6/main.go
...
type Server struct {
	pb.UnimplementedBackend6Server
}

const serviceName = "backend6"
...
func (s *Server) Run() error {
	...
	pb.RegisterBackend6Server(srv, s)

	reflection.Register(srv)
	port := 2000
	if sidecar {
		port = utils.StrToInt(utils.GetEnvVar("backend6_PORT", true))
	}
...
func (s *Server) F7(ctx context.Context, req *pb.Request) (*pb.Response, error) {
	utils.BusyLoop(640)
